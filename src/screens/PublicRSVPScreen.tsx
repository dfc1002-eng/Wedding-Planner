...
const PublicRSVPScreen: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FDFBF7] flex flex-col items-center justify-center p-6 font-sans">
      ...
      <div className="mt-8 flex flex-col items-center gap-1 text-gray-400 opacity-60 text-center">
        <div className="flex items-center gap-2">
          <Icon name="favorite" className="text-xs text-brand-gold animate-pulse" />
          <span className="text-xs font-medium">Meu Sim App</span>
        </div>
        <span className="text-[9px]">Planejando o Casamento dos meus Sonhos</span>
      </div>
    </div>
  );
};
