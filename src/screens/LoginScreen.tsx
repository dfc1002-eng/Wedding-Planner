    ...
    <div className="min-h-screen bg-[#FDFBF7] dark:bg-gray-900 flex items-center justify-center p-6 font-sans">
      <div className="max-w-md w-full bg-white dark:bg-gray-800 rounded-3xl shadow-xl overflow-hidden border border-gray-100 dark:border-gray-700 p-8">
        <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-title text-brand-gray dark:text-white mb-1">Meu Sim</h1>
            <p className="text-gray-500 dark:text-gray-400 text-xs italic mb-2">Planejando o Casamento dos meus Sonhos</p>
            <p className="text-gray-400 dark:text-gray-500 text-sm">A sua jornada para o grande dia começa aqui!</p>
        </div>
